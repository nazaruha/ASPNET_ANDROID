...
namespace WebPipi.Migrations
{
    ...
    [Migration("20231106102027_Add Identity table")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebPipi.Data.Entities.Identity.RoleEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WebPipi.Data.Entities.Identity.UserEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("WebPipi.Data.Entities.Identity.RoleEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WebPipi.Data.Entities.Identity.UserRoleEntity", b =>
                {
                    b.HasOne("WebPipi.Data.Entities.Identity.RoleEntity", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
